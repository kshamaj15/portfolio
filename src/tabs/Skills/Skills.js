...
const Skills = () => {
    const [skills, setSkills] = useState([
        ...
        { name: 'Angular', expertise: '8', image: angular, color: '#a6120d'},
        ...
        { name: 'Bootstrap', expertise: '6', image: bootstrap, color: '#563d7c'},
        { name: 'SCSS', expertise: '8', image: scss, color: '#cd6799'},
        { name: 'jQuery', expertise: '6', image: jquery, color: '#0868AC'},
        { name: 'Node JS', expertise: '6', image: node, color: '#3C873A'}
    ]);
